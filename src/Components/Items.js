const menu=[
    ...
    price:"60"},
    {name:"Hot Chocolate with Biscuit cup",
    price:"65"},
    ...
    price:"99",
    subheading:"Khichiya papad with fusion of Indian and Continental style"},
    {name:"Mexican Masala",
    price:"159",
    subheading:"Kurkuri bites Nachos served with fusion style of Indian and Mexican style along with cheese sauce"},
    {name:"Beans Nachos",
    price:"249",
    ...
    {name:"Quesadilla",
    price:"219",
    subheading:"Crunchy tortilla stuff with fresh vegies Mexican marinating and cheese"},{name:"Mexican Chilly Beans",
    price:"119",
    ...
    {name:"Hummus Platter",
    price:"319",
    subheading:"Classic Lebne Platter served with different type of hummus and accomplishments"},
    ...
    price:"179",
    subheading:"Best wrap for the diet person lots of vegetables and less of carb"},
    {name:"Mexican Burrito Wrap",
    price:"199",
    subheading:"Wrap stuff with Mexican rice and cheese topped with vegetables"},
    {name:"Tandoori Paneer Shawarma Wrap",
    price:"199",
    subheading:"Shawarma with the twist taste along with Indian Spice"},
    {name:"Mushroom wrap",
    price:"179",
    subheading:"Sautéed mushroom stuff along with toasted vegies and cheese"},
    {name:"Falafel Wrap",
    price:"219",
    subheading:"Classic wrap stuff with Falafel and hummus"},
    {name:"Falafel Pocket",
    price:"239",
    subheading:"Fresh cut vegies stuff in pita pocket along with hummus and sour cream"}]},
    ...
    {name:"Veg Cheese ",
    price:"89",
    subheading:"Freshly cut veggies sandwich like Mumbai topped with cheese"},
    {name:"Masala Grill",
    price:"189",
    ...
    price:"149",
    subheading:"Chopped vegetables coated with spicy marinating and load with cheese"},
    {name:"Paneer Toast",
    price:"159",
    subheading:"special in house sauce coated with small cut paneer and vegies"},
    {name:"Dostea Special Toast Sandwich",
    price:"179",
    subheading:"Melted cheese with sautéed vegies stuff between crunchy breads"}]},
    ...
    price:"249",
    subheading:"Flavored cilantro rice served with cheese burnt garlic sauce"},
    ...
    {name:"Samosa",
    price:"50",
    subheading:"Rich flavour of punjabi cuisine served with flavoured dips"}]},
    ...
    price:"499 ",
    subheading:"Mexican rice served with curry ,patty,sautéed veg and fries"},
    {name:"Herb Sizzler",
    price:"519",
    subheading:"Aromatic flavor Herbs served with cheese sauce sautéed veg and fries"},
    {name:"Oriental Sizzler",
    price:"449",
    subheading:"Oriental style sizzler serve rice Cottage Cheese Gravy Sautéed Veg and fries"},
    {name:"Pasta in Pasta",
    price:"539",
    subheading:"Two flavor pasta in one plate along with Garlic bread Sautéed Veg and fries"}]},
    
    {Heading:"SALAD",
    item:[
    {name:"Greek farmer salad",
    price:"199",
    subheading:"Fresh cut Vegies coated with in house flavor oil topped with cheese and olives"},
    {name:"Classic Cesar salad ",
    price:"199",
    subheading:"Herb crotons and ice burg coated with Cesar sauce topped with parmesan cheese"},
